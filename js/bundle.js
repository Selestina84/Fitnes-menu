...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _servises__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./servises */ "./js/modules/servises.js");


function cards(){
  Object(_servises__WEBPACK_IMPORTED_MODULE_0__["getResourse"])("https://my-json-server.typicode.com/Selestina84/Fitnes-menu/menu")
  .then(data => {
...
/* harmony import */ var _servises__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./servises */ "./js/modules/servises.js");
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form){
    ...
    Object(_servises__WEBPACK_IMPORTED_MODULE_1__["postData"])('https://my-json-server.typicode.com/Selestina84/Fitnes-menu/requests', JSON.stringify(object))
      .then(json =>{
        console.log(json);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
function slider({container, slide, prevSelector, nextSelector, totalCounter, currentCounter, wrapper, field}){
  let offset = 0;
  let slideIndex = 1;
